...
public class PopUpText : MonoBehaviour
{
    ...
    private void OpenPopUp()
    {
        ...
        GameObject popupcanvas = canvascontrol.transform.Find("PopupCanvasTEXT").gameObject;
    ...
    {
        // Deactivate canvas
        GameObject.Find("PopupCanvasTEXT").SetActive(false);
        ...
        dc.StopTimer(title+" (txt)", starttime_popup);
