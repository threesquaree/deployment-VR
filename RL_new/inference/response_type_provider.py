...
# Must match the TRAINING env's response_type_labels exactly, INCLUDING order
# (rl-agent-thesis src/environment/env.py:211-213) — the one-hot index of each
# label is baked into the trained network.
