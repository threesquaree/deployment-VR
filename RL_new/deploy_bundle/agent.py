...
class FlatActorCriticAgent:
    ...
    def select_action(
        ...
        return {
            ...
            # Additive logit mask used at selection time (0 = valid, -1e10 =
            # invalid); the trainer must apply the same mask so the gradient
            # is taken w.r.t. the policy that actually acted.
            "action_mask": mask.cpu().tolist(),
        }
